...
abstract class BaseProjectdocument extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'ISG\\ProjectSubmissionAppBundle\\Model\\ProjectdocumentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectdocumentPeer
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::USER_ID;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::VERSION;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::TYPE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::NAME;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::STATUS;
        }
    ...
    public function setDocument($v)
    {
        ...
        if ($this->document !== $v) {
            $this->document = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::DOCUMENT;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::CREATED_BY;
        }
    ...
    public function setCreatedOn($v)
    {
        ...
        if ($this->created_on !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectdocumentPeer::CREATED_ON;
            }
    ...
    public function setModifiedBy($v)
    {
        ...
        if ($this->modified_by !== $v) {
            $this->modified_by = $v;
            $this->modifiedColumns[] = ProjectdocumentPeer::MODIFIED_BY;
        }
    ...
    public function setModifiedOn($v)
    {
        ...
        if ($this->modified_on !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectdocumentPeer::MODIFIED_ON;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->document = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            $this->modified_on = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->resetModified();
            ...
            return $startcol + 12; // 12 = ProjectdocumentPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectdocumentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectdocumentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectdocumentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectdocumentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROJECT_ID`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`VERSION`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`STATUS`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::DOCUMENT)) {
            $modifiedColumns[':p' . $index++]  = '`DOCUMENT`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::CREATED_ON)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_ON`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::MODIFIED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`MODIFIED_BY`';
        }
        if ($this->isColumnModified(ProjectdocumentPeer::MODIFIED_ON)) {
            $modifiedColumns[':p' . $index++]  = '`MODIFIED_ON`';
        }

        $sql = sprintf(
            'INSERT INTO `ProjectDocument` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Projectdocument'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Projectdocument'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectdocumentPeer::USER_ID)) $criteria->add(ProjectdocumentPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(ProjectdocumentPeer::PROJECT_ID)) $criteria->add(ProjectdocumentPeer::PROJECT_ID, $this->project_id);
        if ($this->isColumnModified(ProjectdocumentPeer::VERSION)) $criteria->add(ProjectdocumentPeer::VERSION, $this->version);
        if ($this->isColumnModified(ProjectdocumentPeer::TYPE)) $criteria->add(ProjectdocumentPeer::TYPE, $this->type);
        if ($this->isColumnModified(ProjectdocumentPeer::NAME)) $criteria->add(ProjectdocumentPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectdocumentPeer::STATUS)) $criteria->add(ProjectdocumentPeer::STATUS, $this->status);
        if ($this->isColumnModified(ProjectdocumentPeer::DOCUMENT)) $criteria->add(ProjectdocumentPeer::DOCUMENT, $this->document);
        if ($this->isColumnModified(ProjectdocumentPeer::CREATED_BY)) $criteria->add(ProjectdocumentPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ProjectdocumentPeer::CREATED_ON)) $criteria->add(ProjectdocumentPeer::CREATED_ON, $this->created_on);
        if ($this->isColumnModified(ProjectdocumentPeer::MODIFIED_BY)) $criteria->add(ProjectdocumentPeer::MODIFIED_BY, $this->modified_by);
        if ($this->isColumnModified(ProjectdocumentPeer::MODIFIED_ON)) $criteria->add(ProjectdocumentPeer::MODIFIED_ON, $this->modified_on);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(ProjectdocumentPeer::USER_ID, $this->user_id);
        $criteria->add(ProjectdocumentPeer::PROJECT_ID, $this->project_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getId()) && (null === $this->getUserId()) && (null === $this->getProjectId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Projectdocument (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Projectdocument Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(PropelPDO $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addProjectdocuments($this);
             */
        }
    ...
    public function getProject(PropelPDO $con = null)
    {
        if ($this->aProject === null && ($this->project_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProject->addProjectdocuments($this);
             */
        }
     ...
     *
     * @return string The value of the 'version' column
     */
