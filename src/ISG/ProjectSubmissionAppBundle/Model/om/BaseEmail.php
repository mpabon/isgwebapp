...
abstract class BaseEmail extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'ISG\\ProjectSubmissionAppBundle\\Model\\EmailPeer';
    ...
    /**
     * The value for the resent_count field.
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $resent_count;
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[] = EmailPeer::PROJECT_ID;
        }
    ...
    public function setFrom($v)
    {
        ...
        if ($this->from !== $v) {
            $this->from = $v;
            $this->modifiedColumns[] = EmailPeer::FROM;
        }
    ...
    public function setTo($v)
    {
        ...
        if ($this->to !== $v) {
            $this->to = $v;
            $this->modifiedColumns[] = EmailPeer::TO;
        }
    ...
    public function setSentDate($v)
    {
        ...
        if ($this->sent_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EmailPeer::SENT_DATE;
            }
     ...
     * @return Email The current object (for fluent API support)
     */
    public function setResentCount($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->resent_count !== $v) {
            $this->resent_count = $v;
            $this->modifiedColumns[] = EmailPeer::RESENT_COUNT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->from = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->to = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            $this->resent_count = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = EmailPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EmailPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(EmailPeer::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROJECT_ID`';
        }
        if ($this->isColumnModified(EmailPeer::FROM)) {
            $modifiedColumns[':p' . $index++]  = '`FROM`';
        }
        if ($this->isColumnModified(EmailPeer::TO)) {
            $modifiedColumns[':p' . $index++]  = '`TO`';
        }
        if ($this->isColumnModified(EmailPeer::SUBJECT)) {
            $modifiedColumns[':p' . $index++]  = '`SUBJECT`';
        }
        if ($this->isColumnModified(EmailPeer::BODY)) {
            $modifiedColumns[':p' . $index++]  = '`BODY`';
        }
        if ($this->isColumnModified(EmailPeer::SENT_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`SENT_DATE`';
        }
        if ($this->isColumnModified(EmailPeer::RESENT_COUNT)) {
            $modifiedColumns[':p' . $index++]  = '`RESENT_COUNT`';
        }
    ...
    {
        if (isset($alreadyDumpedObjects['Email'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Email'][serialize($this->getPrimaryKey())] = true;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setFrom($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setTo($arr[$keys[4]]);
        ...
        if (array_key_exists($keys[8], $arr)) $this->setResentCount($arr[$keys[8]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmailPeer::PROJECT_ID)) $criteria->add(EmailPeer::PROJECT_ID, $this->project_id);
        if ($this->isColumnModified(EmailPeer::FROM)) $criteria->add(EmailPeer::FROM, $this->from);
        if ($this->isColumnModified(EmailPeer::TO)) $criteria->add(EmailPeer::TO, $this->to);
        ...
        if ($this->isColumnModified(EmailPeer::SENT_DATE)) $criteria->add(EmailPeer::SENT_DATE, $this->sent_date);
        if ($this->isColumnModified(EmailPeer::RESENT_COUNT)) $criteria->add(EmailPeer::RESENT_COUNT, $this->resent_count);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(EmailPeer::USER_ID, $this->user_id);
        $criteria->add(EmailPeer::PROJECT_ID, $this->project_id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setResentCount($this->getResentCount());
     ...
     *
     * @return string The value of the 'from' column
     */
    public function __toString()
    {
        return (string) $this->getFrom();
    }
