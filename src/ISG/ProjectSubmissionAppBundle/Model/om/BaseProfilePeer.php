...
use ISG\ProjectSubmissionAppBundle\Model\map\ProfileTableMap;
...
abstract class BaseProfilePeer
{
    ...
    const OM_CLASS = 'ISG\\ProjectSubmissionAppBundle\\Model\\Profile';
    ...
    const CREATED_ON = 'Profile.CREATED_ON';

    /** the column name for the MODIFIED_BY field */
    const MODIFIED_BY = 'Profile.MODIFIED_BY';

    /** the column name for the MODIFIED_ON field */
    const MODIFIED_ON = 'Profile.MODIFIED_ON';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'CreatedBy', 'CreatedOn', 'ModifiedBy', 'ModifiedOn', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'createdBy', 'createdOn', 'modifiedBy', 'modifiedOn', ),
        BasePeer::TYPE_COLNAME => array (ProfilePeer::ID, ProfilePeer::NAME, ProfilePeer::DESCRIPTION, ProfilePeer::CREATED_BY, ProfilePeer::CREATED_ON, ProfilePeer::MODIFIED_BY, ProfilePeer::MODIFIED_ON, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DESCRIPTION', 'CREATED_BY', 'CREATED_ON', 'MODIFIED_BY', 'MODIFIED_ON', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'created_by', 'created_on', 'modified_by', 'modified_on', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'CreatedBy' => 3, 'CreatedOn' => 4, 'ModifiedBy' => 5, 'ModifiedOn' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'createdBy' => 3, 'createdOn' => 4, 'modifiedBy' => 5, 'modifiedOn' => 6, ),
        BasePeer::TYPE_COLNAME => array (ProfilePeer::ID => 0, ProfilePeer::NAME => 1, ProfilePeer::DESCRIPTION => 2, ProfilePeer::CREATED_BY => 3, ProfilePeer::CREATED_ON => 4, ProfilePeer::MODIFIED_BY => 5, ProfilePeer::MODIFIED_ON => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, 'CREATED_BY' => 3, 'CREATED_ON' => 4, 'MODIFIED_BY' => 5, 'MODIFIED_ON' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'created_by' => 3, 'created_on' => 4, 'modified_by' => 5, 'modified_on' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProfilePeer::DESCRIPTION);
            $criteria->addSelectColumn(ProfilePeer::CREATED_BY);
            $criteria->addSelectColumn(ProfilePeer::CREATED_ON);
            $criteria->addSelectColumn(ProfilePeer::MODIFIED_BY);
            $criteria->addSelectColumn(ProfilePeer::MODIFIED_ON);
        } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += ProfilePeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ProfileuserPeer::PROFILE_ID, $obj->getId());
